...
do
  ...
  do
    for i in {0..4};
    do lesseg_unet -o "/media/chrisfoulon/DATA1/a_imagepool_mr/noise_increment_experiment/noise_increment/${noise_type}_${incr}/fold_${i}" \
      ...
      -trs destructive_${noise_type} -nw 3 -mt swin-unetr -overlap -sa \
